        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl transition-shadow">
              ...
              <a href="mailto:support@roommate.com" className="text-indigo-600 font-semibold hover:text-indigo-700">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl transition-shadow">
              ...
              <a href="tel:+911234567890" className="text-green-600 font-semibold hover:text-green-700">
                +91 123 456 7890
              </a>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="flex space-x-4">
                <a href="#" className="bg-gray-100 p-3 rounded-lg hover:bg-indigo-600 hover:text-white transition-all">
        ...
        <div className="mt-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white rounded-xl shadow-md p-6">
              <h3 className="text-lg font-bold text-gray-800 mb-2">How do I list my property?</h3>
              <p className="text-gray-600">Simply create an account as an owner and click on "List Property" to add your hostel details and images.</p>
            </div>
            <div className="bg-white rounded-xl shadow-md p-6">
              <h3 className="text-lg font-bold text-gray-800 mb-2">Is there a booking fee?</h3>
              <p className="text-gray-600">We charge a small service fee for each booking to maintain and improve our platform.</p>
            </div>
            <div className="bg-white rounded-xl shadow-md p-6">
              <h3 className="text-lg font-bold text-gray-800 mb-2">How can I contact property owners?</h3>
              <p className="text-gray-600">Once you view a listing, you'll find contact information and a direct messaging option on the property page.</p>
            </div>
            <div className="bg-white rounded-xl shadow-md p-6">
              <h3 className="text-lg font-bold text-gray-800 mb-2">What if I need to cancel?</h3>
              <p className="text-gray-600">Please refer to our cancellation policy or contact our support team for assistance with cancellations.</p>
            </div>
          </div>
        </div>
      </div>
